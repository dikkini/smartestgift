        ...
        <ul class="list-group">
            <c:forEach items="${alienSmartUser.smartUserGifts}" var="smartUserGift" end="3">
                <li class="list-group-item">
                    <blockquote>
                        <p>
                            <a href="/gifts/gift/<c:out value="${smartUserGift.giftShop.uuid}"/>"><c:out value="${smartUserGift.giftShop.gift.name}"/></a>
                        </p>
                    ...
                    <button data-gift-uuid="<c:out value="${smartUserGift.giftShop.uuid}"/>" class="btn btn-default un-want-gift-btn"><spring:message code="label.un_want_gift_button"/></button>
                </li>
            </c:forEach>
