        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-xs-6">
                        <div class="col-xs-6">
                            <input id="find-gift-input" type="text" class="form-control"
                                   placeholder="<spring:message code="label.searchGiftPlaceHolder"/>">
                        </div>
                        <div class="btn-group">
                            <button id="find-gift-btn" class="btn btn-default"><spring:message
                                    code="label.find"/></button>
                            <button id="random-gift-btn" class="btn btn-default"><spring:message
                                    code="label.random_gift"/></button>
                        </div>
                    </div>
                    <div class="col-xs-3">
