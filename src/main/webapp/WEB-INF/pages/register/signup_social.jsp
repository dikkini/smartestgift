...
<jsp:useBean id="emailError" type="java.lang.Boolean" scope="request"/>
<jsp:useBean id="usernameError" type="java.lang.Boolean" scope="request"/>

<jsp:include page="../template/top.jsp"/>

<div class="well well-lg">
    <form:form method="POST" commandName="registerSocialSmartUserDTO" action="/signup/facebook/register.do" cssClass="form-horizontal">
        <div class="form-group has-feedback">
            ...
            <div class="col-xs-4">
                ...
                <span id="username-not-ok-icon" class="glyphicon glyphicon-remove form-control-feedback"
                      <c:if test="${!usernameError}">style="display: none;"</c:if>></span>
                <span id="username-busy-error" class="required"
                      <c:if test="${!usernameError}">style="display: none;"</c:if>>
